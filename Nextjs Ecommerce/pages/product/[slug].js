            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-8 text-white bg-green-700 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-green-500 rounded">
                  Buy Now
                </button>
                <button
                  onClick={() => {
                  ...
                  className="flex ml-4 text-white bg-orange-400 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-300 rounded">
                  Add to Cart
                </button>
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input
                  ...
                  className="px-2 border-2  border-indigo-200 rounded-md"
