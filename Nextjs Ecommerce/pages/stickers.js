      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length===0 && <p>Sorry! All the Stickers are OUT OF STACK. New stock coming SOON. Stay tuned.</p>}
            {Object.keys(products).map((item) => {
              return (
                <Link
                  ...
                  legacyBehavior>
                  <div className="lg:w-1/5 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-9">
